 ...
 *
 * Disassembly of DSDT.aml, Tue Feb 13 15:38:02 2018
 *
                ...
                Device (MAP1)
                {
                                    ...
                                    While (One)
                                    {
                                        ...
                                        If (LEqual (_T_1, 0x02C6E430))
                                        {
                                            If (And (CMSR (0x6C), 0xC0))
                                            {
                                                While (One)
                                                {
                                                    ...
                                                    ElseIf (LEqual (_T_2, 0x6B))
                                                    {
                                                        Return (LD41)
                                                    }
                                                    ElseIf (LEqual (_T_2, 0x6C))
                                                    {
                                                        Return (LD42)
                                                    }
                                                    ElseIf (LEqual (_T_2, 0x6D))
                                                    {
                                                        Return (LD40)
                                                    }
                                                    ElseIf (LEqual (_T_2, 0x6E))
                                                    {
                                                        Return (LD41)
                                                    }
                                                    ElseIf (LEqual (_T_2, 0x6F))
                                                    {
                                                        Return (LD42)
                                                    }
                                            ...
                                            Else
                                            {
                                                While (One)
                                                {
                                                    ...
                                                    ElseIf (LEqual (_T_3, 0x6B))
                                                    {
                                                        Return (LD21)
                                                    }
                                                    ElseIf (LEqual (_T_3, 0x6C))
                                                    {
                                                        Return (LD22)
                                                    }
                                                    ElseIf (LEqual (_T_3, 0x6D))
                                                    {
                                                        Return (LD20)
                                                    }
                                                    ElseIf (LEqual (_T_3, 0x6E))
                                                    {
                                                        Return (LD21)
                                                    }
                                                    ElseIf (LEqual (_T_3, 0x6F))
                                                    {
                                                        Return (LD22)
                                                    }
                                        ...
                                        ElseIf (LEqual (_T_1, 0x020CE430))
                                        {
                                            If (And (CMSR (0x6C), 0xC0))
                                            {
                                                While (One)
                                                {
                                                    ...
                                                    ElseIf (LEqual (_T_4, 0x6B))
                                                    {
                                                        Return (LD61)
                                                    }
                                                    ElseIf (LEqual (_T_4, 0x6C))
                                                    {
                                                        Return (LD62)
                                                    }
                                                    ElseIf (LEqual (_T_4, 0x6D))
                                                    {
                                                        Return (LD60)
                                                    }
                                                    ElseIf (LEqual (_T_4, 0x6E))
                                                    {
                                                        Return (LD61)
                                                    }
                                                    ElseIf (LEqual (_T_4, 0x6F))
                                                    {
                                                        Return (LD62)
                                                    }
                                            ...
                                            Else
                                            {
                                                While (One)
                                                {
                                                    ...
                                                    ElseIf (LEqual (_T_5, 0x6B))
                                                    {
                                                        Return (LD31)
                                                    }
                                                    ElseIf (LEqual (_T_5, 0x6C))
                                                    {
                                                        Return (LD32)
                                                    }
                                                    ElseIf (LEqual (_T_5, 0x6D))
                                                    {
                                                        Return (LD30)
                                                    }
                                                    ElseIf (LEqual (_T_5, 0x6E))
                                                    {
                                                        Return (LD31)
                                                    }
                                                    ElseIf (LEqual (_T_5, 0x6F))
                                                    {
                                                        Return (LD32)
                                                    }
                                        ...
                                        ElseIf (LEqual (_T_1, 0x0318E430))
                                        {
                                            While (One)
                                            {
                                                ...
                                                ElseIf (LEqual (_T_6, 0x6B))
                                                {
                                                    Return (LD41)
                                                }
                                                ElseIf (LEqual (_T_6, 0x6C))
                                                {
                                                    Return (LD42)
                                                }
                                                ElseIf (LEqual (_T_6, 0x6D))
                                                {
                                                    Return (LD40)
                                                }
                                                ElseIf (LEqual (_T_6, 0x6E))
                                                {
                                                    Return (LD41)
                                                }
                                                ElseIf (LEqual (_T_6, 0x6F))
                                                {
                                                    Return (LD42)
                                                }
                                        ...
                                        ElseIf (LEqual (_T_1, 0x0304E430))
                                        {
                                            While (One)
                                            {
                                                ...
                                                ElseIf (LEqual (_T_7, 0x6B))
                                                {
                                                    Return (LD11)
                                                }
                                                ElseIf (LEqual (_T_7, 0x6C))
                                                {
                                                    Return (LD12)
                                                }
                                                ElseIf (LEqual (_T_7, 0x6D))
                                                {
                                                    Return (LD10)
                                                }
                                                ElseIf (LEqual (_T_7, 0x6E))
                                                {
                                                    Return (LD11)
                                                }
                                                ElseIf (LEqual (_T_7, 0x6F))
                                                {
                                                    Return (LD12)
                                                }
                                        ...
                                        Else
                                        {
                                            While (One)
                                            {
                                                ...
                                                ElseIf (LEqual (_T_8, 0x6B))
                                                {
                                                    Return (LD11)
                                                }
                                                ElseIf (LEqual (_T_8, 0x6C))
                                                {
                                                    Return (LD12)
                                                }
                                                ElseIf (LEqual (_T_8, 0x6D))
                                                {
                                                    Return (LD10)
                                                }
                                                ElseIf (LEqual (_T_8, 0x6E))
                                                {
                                                    Return (LD11)
                                                }
                                                ElseIf (LEqual (_T_8, 0x6F))
                                                {
                                                    Return (LD12)
                                                }
                    ...
                    Method (WMBB, 3, Serialized)
                    {
                        ...
                        If (LOr (LEqual (Arg1, One), LEqual (Arg1, 0x02)))
                        {
                            While (One)
                            {
                                Store (Z00J (Local0, Zero), _T_0)
                                If (LEqual (_T_0, 0x0109))
                                {
