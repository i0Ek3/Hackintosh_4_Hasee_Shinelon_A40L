 ...
 *
 * Disassembly of SSDT4.aml, Sat Feb 10 14:57:10 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003973 (14707)
 *     Revision         0x01
 *     Checksum         0xF3
 *     OEM ID           "HASEE "
 ...
 */
DefinitionBlock ("SSDT4.aml", "SSDT", 1, "HASEE ", "PARADISE", 0x00003000)
{
    /*
     * iASL Warning: There were 18 external control methods found during
     * disassembly, but only 15 were resolved (3 unresolved). Additional
    ...
    External (_SB_.CUNM, UnknownObj)    // Warning: Unknown object
    ...
    OperationRegion (SANV, SystemMemory, 0x9CFA8D98, 0x0141)
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Device (B0D3)
        {
            ...
            Method (ABWA, 1, Serialized)
            {
                If (Arg0)
                {
                    If (LAnd (LNotEqual (And (ABAR, 0xFFFFC004), 0xFFFFC004), LEqual (And (ABAR, 0xFFFFC000), Zero)))
                    {
                        Store (ABAR, TBAR)
                        Store (ACMD, TCMD)
                        Store (BARA, ABAR)
        ...
        Device (IGPU) //related about hd graphic
        {
            ...
            Device (DD1F)
            {
                ...
                {
                    Store (QBQC (), Local0)
                    If (LLess (Local0, Subtract (PLD1, 0x03)))
                    {
                        Store (PLD1, Local1)
                    }
                    ElseIf (LLess (Local0, Subtract (PLD2, 0x03)))
                    {
                        Store (PLD2, Local1)
                    }
                    ElseIf (LLess (Local0, Subtract (PLD3, 0x03)))
                    {
                        Store (PLD3, Local1)
                    }
                    ElseIf (LLess (Local0, Subtract (PLD4, 0x03)))
                    {
                        Store (PLD4, Local1)
                    }
                    ElseIf (LLess (Local0, Subtract (PLD5, 0x03)))
                    {
                        Store (PLD5, Local1)
                    }
                    ElseIf (LLess (Local0, Subtract (PLD6, 0x03)))
                    {
                        Store (PLD6, Local1)
                    }
                    ElseIf (LLess (Local0, Subtract (PLD7, 0x03)))
                    {
                        Store (PLD7, Local1)
                    }
                    Else
                ...
                Method (BRDN, 0, NotSerialized)
                {
                    Store (QBQC (), Local0)
                    If (LGreater (Local0, Add (PLD7, 0x03)))
                    {
                        Store (PLD7, Local1)
                    }
                    ElseIf (LGreater (Local0, Add (PLD6, 0x03)))
                    {
                        Store (PLD6, Local1)
                    }
                    ElseIf (LGreater (Local0, Add (PLD5, 0x03)))
                    {
                        Store (PLD5, Local1)
                    }
                    ElseIf (LGreater (Local0, Add (PLD4, 0x03)))
                    {
                        Store (PLD4, Local1)
                    }
                    ElseIf (LGreater (Local0, Add (PLD3, 0x03)))
                    {
                        Store (PLD3, Local1)
                    }
                    ElseIf (LGreater (Local0, Add (PLD2, 0x03)))
                    {
                        Store (PLD2, Local1)
                    }
                    ElseIf (LGreater (Local0, Add (PLD1, 0x03)))
                    {
                        Store (PLD1, Local1)
                    }
                    Else
                ...
                Method (LGBR, 1, NotSerialized)
                {
                    If (LLessEqual (Arg0, PLD0))
                    {
                        Store (Zero, Local1)
                    }
                    ElseIf (LLessEqual (Arg0, PLD1))
                    {
                        Store (One, Local1)
                    }
                    ElseIf (LLessEqual (Arg0, PLD2))
                    {
                        Store (0x02, Local1)
                    }
                    ElseIf (LLessEqual (Arg0, PLD3))
                    {
                        Store (0x03, Local1)
                    }
                    ElseIf (LLessEqual (Arg0, PLD4))
                    {
                        Store (0x04, Local1)
                    }
                    ElseIf (LLessEqual (Arg0, PLD5))
                    {
                        Store (0x05, Local1)
                    }
                    ElseIf (LLessEqual (Arg0, PLD6))
                    {
                        Store (0x06, Local1)
                    }
                    ElseIf (LLessEqual (Arg0, PLD7))
                    {
                        Store (0x07, Local1)
                    }
                    Else
                ...
                Method (BRDT, 0, NotSerialized)
                {
                    And (0xFF, CBLV, Local0)
                    If (LLessEqual (Local0, PLD0))
                    {
                        Store (One, Local1)
                    }
                    ElseIf (LLessEqual (Local0, PLD1))
                    {
                        Store (0x02, Local1)
                    }
                    ElseIf (LLessEqual (Local0, PLD2))
                    {
                        Store (0x03, Local1)
                    }
                    ElseIf (LLessEqual (Local0, PLD3))
                    {
                        Store (0x04, Local1)
                    }
                    ElseIf (LLessEqual (Local0, PLD4))
                    {
                        Store (0x05, Local1)
                    }
                    ElseIf (LLessEqual (Local0, PLD5))
                    {
                        Store (0x06, Local1)
                    }
                    ElseIf (LLessEqual (Local0, PLD6))
                    {
                        Store (0x07, Local1)
                    }
                    ElseIf (LLessEqual (Local0, PLD7))
                    {
                        Store (0x08, Local1)
                    }
                    Else
